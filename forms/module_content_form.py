"""
Module Content Form
Form for displaying module content information and details
"""
...
class ModuleContentForm(QDialog):
    """Form for displaying module content information and details"""
    ...
    def setup_ui(self):
        """Setup the form UI"""
        self.setWindowTitle("Module Content Information")
        self.resize(600, 500)
    ...
    def set_content(self, content: IContent, course: Optional[ICourse] = None, 
        ...
        if content:
            self.setWindowTitle(f"Module Content: {content.name}")
