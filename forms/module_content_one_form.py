"""
Module Content One Form
Form for displaying single module content information and details
"""
...
class ModuleContentOneForm(QDialog):
    """Form for displaying single module content information and details"""
    ...
    def setup_ui(self):
        """Setup the form UI"""
        self.setWindowTitle("Module Content (Single) Information")
        self.resize(600, 500)
    ...
    def set_content(self, content: IContent, course: Optional[ICourse] = None, 
        ...
        if content:
            self.setWindowTitle(f"Module Content (Single): {content.name}")
